...
Two portable solutions are included. **Option A is active in this repository.**

### Option A — Runtime patch *(default)*
...
### Option B — Patched fork of `google-adk` (see RefugeeConnect2 repository)
